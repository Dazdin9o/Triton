    ...
    namespace python {
      ...
      void initMemoryAccessObject(pybind11::module& pyTriton) {
        pybind11::class_<triton::arch::MemoryAccess>(pyTriton, "MemoryAccess", "The MemoryAccess class")
          ...
          .def("getBaseRegister",     &triton::arch::MemoryAccess::getBaseRegister, pybind11::return_value_policy::reference_internal)
          .def("getBitSize",          &triton::arch::MemoryAccess::getBitSize)
          .def("getDisplacement",     &triton::arch::MemoryAccess::getDisplacement, pybind11::return_value_policy::reference_internal)
          .def("getIndexRegister",    &triton::arch::MemoryAccess::getIndexRegister, pybind11::return_value_policy::reference_internal)
          .def("getLeaAst",           &triton::arch::MemoryAccess::getLeaAst)
          .def("getScale",            &triton::arch::MemoryAccess::getScale, pybind11::return_value_policy::reference_internal)
          .def("getSegmentRegister",  &triton::arch::MemoryAccess::getSegmentRegister, pybind11::return_value_policy::reference_internal)
