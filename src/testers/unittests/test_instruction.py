...
class TestInstruction(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.Triton.setConcreteRegisterValue(self.Triton.registers.x86_rax, 0x1122334455667788)
        self.Triton.setConcreteRegisterValue(self.Triton.registers.x86_rbx, 0x8877665544332211)
...
class TestLoadAccess(unittest.TestCase):
    ...
    def test_load_immediate_fs(self):
        ...
        self.Triton.setConcreteRegisterValue(self.Triton.registers.x86_fs, 0x7fffda8ab700)
    ...
    def test_load_indirect_fs(self):
        ...
        self.Triton.setConcreteRegisterValue(self.Triton.registers.x86_fs, 0x7fffda8ab700)
        self.Triton.setConcreteRegisterValue(self.Triton.registers.x86_rax, 0xffffffffffffdf90)
        self.Triton.processing(inst)
